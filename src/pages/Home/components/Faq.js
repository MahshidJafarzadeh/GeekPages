...
export const Faq = () => {
    const faqs = [
        {
          "id": 1,
          "question": "Why should you use GeekPages?",
  ...
  return (
    <section className="my-10 p-7 border rounded dark:border-slate-700 shadow-sm">        
      <h1 className="text-2xl text-center font-semibold dark:text-slate-100 mb-3 underline underline-offset-8 font-Vazirmatn">سوالی دارید؟ شاید جوابشو این‌جا پیدا کردید</h1>    
